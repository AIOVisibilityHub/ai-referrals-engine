        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              AI Visibility Hub is fully automated n8n software with 100+ built-in automations that position your business to be recommended by every major AI platform—without learning any code.
            </p>
          </div>
