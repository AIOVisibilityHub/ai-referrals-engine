        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <span className="text-foreground font-medium">
              <br></br>👉 AI Referrals Hub™ positions your firm as the answer through "case-type + location" authority mapping with <span className="text-gradient-gold">M2C (Machine-to-Consumer)</span> Marketing. <br>You can DIY or we do it for you → Watch the demo below.
            </span>
          </p>
